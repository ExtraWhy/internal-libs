...
type Player struct {
	...
	Id     *uint64 `protobuf:"varint,2,req,name=id" json:"id,omitempty"`         // Unique ID number for this person.
...
var file_player_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x02, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x6e,
